...
class EditStudent extends Component {
    ...
    componentDidMount() {
        ...
        const ref = firebase.firestore().collection('students').doc(id);
        console.log(id)
        ref.get().then((doc) => {
            if (doc.exists) {
    ...
    onSubmit = (e) => {
        ...
        updateRef.set({
            ...
            this.props.history.push("/app/list-of-students")
    ...
    render() {
        return (
            <form autoComplete="off" className="modal-box-students" onSubmit={this.onSubmit}>
